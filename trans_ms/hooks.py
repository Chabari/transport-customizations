...
jinja = {
	"methods": [
		"trans_ms.transport_management.doctype.vehicle_trip.vehicle_trip.get_trip_rate",
		"trans_ms.transport_management.doctype.vehicle_trip.vehicle_trip.get_trip_total",
		"trans_ms.transport_management.doctype.vehicle_trip.vehicle_trip.get_order_items",
	],
}
        ...
        "filters": [
            [
                ...
                (
                    ...
                    "Transport Assignment-custom_shipping_address",
                    "Vehicle Trip-custom_shipping_address",
                    "Vehicle Trip-custom_has_local_trip",
                    "Vehicle Trip-custom_transport_order",
                    "Vehicle Trip-custom_parent_trip",
                    "Vehicle Trip-custom_offloaded_quantity",
                    "Vehicle Trip-custom_loaded_quantity",
