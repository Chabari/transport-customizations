...
def make_expense_claim(docname):
	...
	vemployee = frappe.get_doc("Employee", vehicle_log.employee)
	...
	exp_claim.cost_center = vehicle_log.license_plate + " - " + company_abbr
	...
	exp_claim.append("expenses",{
		...
		"cost_center": vehicle_log.license_plate   + " - " + company_abbr
	})
